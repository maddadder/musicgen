    ...
    : IRabbitMQPersistentConnection
{
    ...
    public DefaultRabbitMQPersistentConnection(ILogger<DefaultRabbitMQPersistentConnection> logger)
    {
        ...
        _logger.LogInformation("DefaultRabbitMQPersistentConnection is created");
    ...
    public bool TryConnect()
    {
        ...
        lock (_syncRoot)
        {
            ...
            {
                _logger.LogInformation("Fatal error: RabbitMQ connections could not be created and opened");
